...
def XGB(X, y, n_calls=20, normalize=False, file=None, save_model=None, save_param=None, save_encoder=None):
...
# **保存 LabelEncoder，预测时用**
    with open(module_path + save_encoder, 'wb') as f:
        pickle.dump(le, f)
